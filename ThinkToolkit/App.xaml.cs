...
using ThinkToolkit.Models;
using ThinkToolkit.Services;
using ThinkToolkit.ViewModels;
using ThinkToolkit.Views;
...
namespace ThinkToolkit
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            {
                MessageBox.Show("PowerBattery.dll has to be present in the same folder as ThinkToolkit.exe", "", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                Application.Current.Shutdown();
            }
